...
public class Test9 {
	...
	void loginUser(String username, String password, String user)
	{
		try
		{
	...
	void handleWelcomeScreen(String user)
	{
		try {
			Thread.sleep(2000);
	...
	void createUser(String firstname, String lastname, String email, String loginName, String pswd, String repaswd, String user)
	{
		try 
		{
	...
	void modifyUserPwd(String paswd, String repswd, String user)
	{
		try {
			oBrowser.findElement(By.xpath("//*[@id=\'topnav\']/tbody/tr[1]/td[5]/a/div[2]")).click();
			//oBrowser.findElement(By.xpath("//a[@*='content users']")).click();
